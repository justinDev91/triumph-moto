  ...
  return (
    <div className="bg-white">
      <div className="relative isolate px-6 pt-4 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-4">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              Découvrez nos dernières motos disponibles.{' '}
          ...
          <div className="text-center">
            <h1 className="text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">
              Découvrez des motos de concessions fiables
            </h1>
            <p className="mt-8 text-lg font-medium text-gray-500 sm:text-xl">
              Explorez les motos de différentes entreprises et concessions, vérifiez leur état d'entretien et trouvez le
              modèle qui vous convient.
            </p>
