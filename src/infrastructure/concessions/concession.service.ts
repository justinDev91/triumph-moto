...
export class ConcessionService {
  ...
  constructor(
    ...
    this.addMotorcycleToConcessionUsecase = new AddMotorcycleToConcessionUsecase(concessionRepository, motorcycleRepository);
  ...
  public async addMotorcycleToConcession(concessionId: string, motorcycleId: string): Promise<void | Error> {
    return this.addMotorcycleToConcessionUsecase.execute(concessionId, motorcycleId);
  }
  ...
  public async removeMotorcycleFromConcession(concessionId: string, motorcycleId: string): Promise<void | Error> {
